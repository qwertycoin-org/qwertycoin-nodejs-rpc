...
var QwertyServiceRPC = function (opts) {
  opts = opts || {}
  if (!(this instanceof QwertyServiceRPC)) return new QwertyServiceRPC(opts)
  this.host = opts.host || '127.0.0.1'
  this.port = opts.port || 8070
  this.timeout = opts.timeout || 2000
  this.ssl = opts.ssl || false
  this.rpcPassword = opts.rpcPassword || false
  this.defaultMixin = (opts.defaultMixin !== undefined) ? opts.defaultMixin : 2
...
QwertyServiceRPC.prototype.reset = function (opts) {
...
QwertyServiceRPC.prototype.save = function () {
  return new Promise((resolve, reject) => {
...
QwertyServiceRPC.prototype.getViewKey = function () {
  return new Promise((resolve, reject) => {
...
QwertyServiceRPC.prototype.getSpendKeys = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
QwertyServiceRPC.prototype.getMnemonicSeed = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.address = opts.address || ''
...
QwertyServiceRPC.prototype.getStatus = function () {
  return new Promise((resolve, reject) => {
...
QwertyServiceRPC.prototype.getAddresses = function () {
  return new Promise((resolve, reject) => {
...
QwertyServiceRPC.prototype.createAddress = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
QwertyServiceRPC.prototype.deleteAddress = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.address = opts.address || ''
...
QwertyServiceRPC.prototype.getBalance = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.address = opts.address || ''
...
QwertyServiceRPC.prototype.getBlockHashes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
QwertyServiceRPC.prototype.getTransactionHashes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
QwertyServiceRPC.prototype.getTransactions = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.addresses = opts.addresses || []
    opts.blockHash = opts.blockHash || false
...
QwertyServiceRPC.prototype.getUnconfirmedTransactionHashes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.addresses = opts.addresses || []
...
QwertyServiceRPC.prototype.getTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
QwertyServiceRPC.prototype.newTransfer = function (address, amount) {
  return {
    address: address,
...
QwertyServiceRPC.prototype.sendTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    var that = this
    opts = opts || {}
    opts.addresses = opts.addresses = []
...
QwertyServiceRPC.prototype.createDelayedTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.addresses = opts.addresses = []
    opts.transfers = opts.transfers || false
...
QwertyServiceRPC.prototype.getDelayedTransactionHashes = function () {
  return new Promise((resolve, reject) => {
...
QwertyServiceRPC.prototype.deleteDelayedTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
QwertyServiceRPC.prototype.sendDelayedTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.transactionHash = opts.transactionHash || false
...
QwertyServiceRPC.prototype.sendFusionTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
QwertyServiceRPC.prototype.estimateFusion = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.threshold = opts.threshold || this.defaultFusionThreshold
    opts.addresses = opts.addresses || []
...
QwertyServiceRPC.prototype.createIntegratedAddress = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
QwertyServiceRPC.prototype.getFeeInfo = function () {
  return this.getNodeFeeInfo()
}

QwertyServiceRPC.prototype.getNodeFeeInfo = function () {
  return new Promise((resolve, reject) => {
...
QwertyServiceRPC.prototype._postToWalletd = function (method, params) {
  return new Promise((resolve, reject) => {
...
module.exports = QwertyServiceRPC
